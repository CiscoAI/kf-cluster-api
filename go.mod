module github.com/CiscoAI/kf-cluster-api
...
require (
	...
	github.com/kubeflow/kfctl/v3 v3.0.0-20200123233633-331fb9d02799
	github.com/kubeflow/kubeflow/components/common v0.0.0-20200128174740-28fe3b22a4c7
